...
#define XIAOMI_SDM439_COOL_0_TEMPERATURE 0
#define XIAOMI_SDM439_COOL_5_TEMPERATURE 50
#define XIAOMI_SDM439_COOL_10_TEMPERATURE 100
#define XIAOMI_SDM439_COOL_15_TEMPERATURE 150
#define XIAOMI_SDM439_COOL_ICL_400MA 0x20		/*JEITA_CCCOMP_COLD=(2000-400)/50*/
#define XIAOMI_SDM439_COOL_ICL_1300MA 0x0E		/*JEITA_CCCOMP_COLD=(2000-1300)/50*/
#define XIAOMI_SDM439_COOL_ICL_1950MA 0x01		/*JEITA_CCCOMP_COLD=(2000-1900)/50*/
#define XIAOMI_SDM439_HOT_ICL_1000MA 0x14		/*JEITA_CCCOMP_HOT=(2000-1000)/50*/
#define XIAOMI_SDM439_HOT_FV_4100MV 0x1D		/*JEITA_FVCOMP_HOT=(4390-4100)/10*/
#define XIAOMI_SDM439_COOL_FV_4400MV 0		/*JEITA_FVCOMP_COLD=(4390-4390)/10*/

#define XIAOMI_SDM439_COOL_ICL_OLIVE_1000MA 0x28		/*JEITA_CCCOMP_COLD=(3000-1000)/50*/
#define XIAOMI_SDM439_COOL_ICL_OLIVE_1950MA 0x15		/*JEITA_CCCOMP_COLD=(3000-1950)/50*/
#define XIAOMI_SDM439_COOL_ICL_OLIVE_2950MA 0x01		/*JEITA_CCCOMP_COLD=(3000-2950)/50*/
#define XIAOMI_SDM439_HOT_ICL_OLIVE_2450MA 0x0B		/*JEITA_CCCOMP_HOT=(3000-2450)/50*/
#endif
...
#if IS_ENABLED(CONFIG_MACH_XIAOMI_SDM439)
#define XIAOMI_SDM439_JEITA_FVCOMP_CFG_COLD_REG	(CHGR_BASE + 0x86)
#define XIAOMI_SDM439_JEITA_FVCOMP_CFG_HOT_REG		(CHGR_BASE + 0x91)
#endif
...
#if IS_ENABLED(CONFIG_MACH_XIAOMI_SDM439)
#define XIAOMI_SDM439_USBIN_AICL_START_AT_MAX_BIT			BIT(5)
#define XIAOMI_SDM439_SUSPEND_ON_COLLAPSE_USBIN_BIT			BIT(7)
#endif

#define USBIN_5V_AICL_THRESHOLD_REG		(USBIN_BASE + 0x81)
#if IS_ENABLED(CONFIG_MACH_XIAOMI_SDM439)
#define XIAOMI_SDM439_USBIN_9V_AICL_THRESHOLD_REG		(USBIN_BASE + 0x82)
#endif
...
#define XIAOMI_SDM439_SNK_RP_STD_DAM_BIT 		BIT(6)
#define XIAOMI_SDM439_SNK_RP_1P5_DAM_BIT 		BIT(5)
#define XIAOMI_SDM439_SNK_RP_3P0_DAM_BIT 		BIT(4)
#define XIAOMI_SDM439_TYPE_C_DEBUG_ACCESS_SINK_REG		 (TYPEC_BASE + 0x4A)
#define XIAOMI_SDM439_EN_CHG_ON_DEBUG_ACCESS_SNK		 BIT(1)
#define XIAOMI_SDM439_DAM_DIS_AICL 		BIT(3)
#define XIAOMI_SDM439_SCHG_USB_TYPE_C_CFG		(USBIN_BASE + 0x58)
#define XIAOMI_SDM439_BC1P2_START_ON_CC			BIT(7)
#endif
static unsigned long long detected_src_type_mask = GENMASK(3, 0);
#define DETECTED_SRC_TYPE_MASK			detected_src_type_mask
...
#if IS_ENABLED(CONFIG_MACH_XIAOMI_SDM439)
static void override_smb5_reg_h_values_for_xiaomi_sdm439(void) {
#if IS_ENABLED(CONFIG_MACH_FAMILY_XIAOMI_OLIVE)
	if (xiaomi_sdm439_mach_get_family() == XIAOMI_SDM439_MACH_FAMILY_OLIVE)
		DETECTED_SRC_TYPE_MASK = GENMASK(6, 0);
#endif
}
#endif
